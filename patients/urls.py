...
urlpatterns = [
    ...
    # Similar patients (for prediction view cards)
    path('<int:subject_id>/<int:stay_id>/<int:hadm_id>/similar-patients', api.get_similar_patients_view, name='similar_patients'),
]
